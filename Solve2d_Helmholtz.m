function u = Solve2d_Helmholtz(f,k,xmin,xmax,ymin,ymax,gl,gr,gb,gt,BCtype,pl,pr,pb,pt)
% Solves the bidimensional equation (Delta+k^2)u=f on the domain
...
% Note that pl, pr, pb, pt are only required for Robin BC
    ...
    % Build A
    A = A2d_Helmholtz(k,xmin,xmax,ymin,ymax,Jx,Jy,BCtype,pl,pr,pb,pt);
