function u = DNParMixed2d_FourSubdomains_EtaMinusDelta(f,eta,x,y,gl,gr,gb,gt,BCtype,pl,pr,pb,pt,uex,a,b,th,Nit,plot_iterates,plot_cvg_curve)
    ...
    for i=1:Nit
        ...
        % Solve a mixed problem in all subdomains  
        % ---------------------------------------
        if (BCtype == 0)
...
%             xlabel('x'); ylabel('y'); zlabel('u');
        ...
        h41 = (1-th)*du4dn41-th*du1dn14;  

        % Update the gij
        % --------------
        g12 = th*u1(:,end)+(1-th)*g12;
        g23 = th*u2(end,:)'+(1-th)*g23;
        g34 = th*u3(:,1)+(1-th)*g34;
