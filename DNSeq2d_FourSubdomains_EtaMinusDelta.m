function u = DNSeq2d_FourSubdomains_EtaMinusDelta(f,eta,x,y,gl,gr,gb,gt,BCtype,pl,pr,pb,pt,uex,a,b,th,Nit,plot_iterates,plot_cvg_curve)
    ...
    e12 = ones(idyb,1);
    NDer12 = [speye(idyb) -spdiags(0.5*[-e12 (4+eta*h^2)*e12 -e12],[-1 0 1],idyb,idyb)]/h;
    ...
    NDer34 = [speye(Jy-idyb+1) -spdiags(0.5*[-e34 (4+eta*h^2)*e34 -e34],[-1 0 1],Jy-idyb+1,Jy-idyb+1)]/h;
    % Correct the values at the corners
    ...
    for i=1:Nit
        ...
        if (BCtype == 0)
            ...
            u1 = Solve2d_EtaMinusDelta(f1,eta,xmin,xa,ymin,yb,gl1,lv*g12,gb1,lv*g41,1,pl1,lv*ones(idyb,1),pb1,lv*ones(idxa,1));
            u3 = Solve2d_EtaMinusDelta(f3,eta,xa,xmax,yb,ymax,lv*g34,gr3,lv*g23,gt3,1,lv*ones(Jy-idyb+1,1),pr3,lv*ones(Jx-idxa+1,1),pt3);
        end 
